# Taken from: https://blogs.rstudio.com/ai/posts/2020-07-30-state-of-the-art-nlp-models-from-r/
...
for (i in 1:length(ai_m)) {
  ...
  model %>% compile(optimizer = keras$optimizers$legacy$Adam(learning_rate = 3e-5, epsilon=1e-08, clipnorm=1.0),

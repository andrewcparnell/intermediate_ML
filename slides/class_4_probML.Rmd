...
- There are very few good packages for fitting Bayesian machine learning models in R, though the `tfprobability` package fits tensorflow models with a probabilistic layer (not clear if Bayesian or not). Currently very hard to use in R

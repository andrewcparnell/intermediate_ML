...
- The activiation function for the final layer in the network needs to match the format of the output (e.g. softmax for probabilistic classification)
...
\tiny
From (https://anhreynolds.com/blogs/cnn.html)
...
- We can fit most of these models very simply with `keras` ...
...
- Once we have got the hang of creating these models we 
